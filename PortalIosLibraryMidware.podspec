#
#  Be sure to run `pod spec lint PortalIosLibraryMidware.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/portal-io/portal-ios-library-midware.git", :tag => "#{s.version}" }
